<template>
  <aside class="about">
    <h2>Olá! ;)</h2>
    <p>Meu nome é Eduardo Garcia e criei esse app para facilitar a vida de quem precisa pegar busão.</p>
    <p>Horários incoretos? sugira mudanças nos contatos abaixo.</p>
